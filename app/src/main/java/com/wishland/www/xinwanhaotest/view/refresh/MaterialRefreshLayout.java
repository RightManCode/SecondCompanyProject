package com.wishland.www.xinwanhaotest.view.refresh;
...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private final static int hIGHER_HEAD_HEIGHT = 120;
    private final static int DEFAULT_PROGRESS_SIZE = 43;
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy >= 16 && !canChildScrollUp()) {
                    ...
                    return true;
                } else if (dy < 16 && !canChildScrollDown() && isLoadMore) {
